...
Offline demo: **`mobile/assets/demo/archive.json`** (~7500 eateries, trails, visits). Regenerated by seed / `build-mobile-archive.mjs`.
...
- `api/prisma/scripts/generate-extra-eateries.mjs` — scales demo archive to ~7500
