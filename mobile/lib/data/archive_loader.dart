  ...
  static Future<ArchiveData> load() async {
    ...
    final eateries = (json['eateries'] as List<dynamic>).map((e) {
      ...
      return Eatery(
        ...
        coverPhotoKind: m['coverPhotoKind'] as String?,
        coverPhotoLicense: m['coverPhotoLicense'] as String?,
        coverPhotoAttribution: m['coverPhotoAttribution'] as String?,
        cuisineIllustrationUrl: m['cuisineIllustrationUrl'] as String?,
