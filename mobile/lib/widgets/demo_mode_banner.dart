...
/// Subtle offline indicator — not a full-width banner (DFD-P1-04).
class DemoModeBanner extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    if (compact) {
      return Semantics(
        label: l10n?.offlineArchiveTitle ?? 'Offline archive',
        child: Tooltip(
          message: l10n?.offlineArchiveBody ?? 'Using bundled Karachi archive',
    ...
    return Padding(
      ...
      child: Align(
        ...
        child: Semantics(
          label: '${l10n?.offlineArchiveTitle ?? 'Offline archive'}. ${l10n?.offlineArchiveBody ?? ''}',
          child: Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                  l10n?.offlineArchiveTitle ?? 'Offline archive',
